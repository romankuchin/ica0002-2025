Final lab related information
------------------------

Final lab task: [README.md](./README.md)


Access
------

Final lab times are listed on the [main course page](../README.md).

You can choose any 2 times to defend the Final lab in addition to week 16 attempt,
3 attempts in total.

To get access to Final lab defence you need to:

1. Complete all the 14 lab tasks
2. Get your solution verified by Judge Dredd:
    http://193.40.157.25/students.html > your-name > Results should be all green
...
Final lab defences start strictly at the announced time and lasts for exactly
...
This is open-everything event: you can use whatever materials you want while
...
Before presenting the final lab you should verify your solution yourself.
...
If you have something different -- fix your code. No point to come to defence until you have achieved the expected result.
Note that we will still check your code during the call.
...
check it any time. We well accept cited online
